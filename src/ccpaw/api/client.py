...
from ccpaw.constant            import (
    AUTHENTICATION_HEADER,
    _AUTHENTICATION_ERROR_STRING
)
from ccpaw._compat             import string_types
from ccpaw.util.array          import (
    sequencify,
    squash
)
...
class Client:
    ...
    with Cell Collective's API through the ccpaw.
